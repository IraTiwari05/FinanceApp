export function convertCurrencyToNumber(currencyString) {
  ...
  return currencyString; // Return unchanged if not a currency string
}
...
export const kpis = [
  ...
  export const convertedKpis = kpis.map(kpi => ({
    ...kpi,
    totalProfit: convertCurrencyToNumber(kpi.totalProfit),
    totalRevenue: convertCurrencyToNumber(kpi.totalRevenue),
    totalExpenses: convertCurrencyToNumber(kpi.totalExpenses),
